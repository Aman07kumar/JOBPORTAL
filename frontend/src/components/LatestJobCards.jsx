    ...
    return (
        ...
        >
            ...
            <div className='flex flex-wrap items-center gap-2'>
                <Badge className='text-yellow-500 font-bold' variant="ghost">{job?.position} Positions</Badge>
                <Badge className='text-yellow-500 font-bold' variant="ghost">{job?.jobType}</Badge>
                <Badge className='text-yellow-500 font-bold' variant="ghost">{job?.salary}LPA</Badge>
            </div>
        </div>
    );
};
